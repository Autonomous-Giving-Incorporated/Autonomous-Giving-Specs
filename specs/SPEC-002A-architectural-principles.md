...
| --- | --- | --- | --- | --- | --- |
| Dependencies | Constitution, SPEC-001, SPEC-002 | Related ADRs | ADR-001, ADR-003, ADR-010 | Related contracts | None |
...
1. Operational complexity (workers, extraction, brokers, orchestration) is justified by measured need, not by architectural fashion.
2. Lifecycle, approval, and evidence integrity take precedence over premature distribution.
...
## Non-goals
This specification does not prescribe programming language, cloud vendor, or a single repository layout for products. It does not change lifecycle stages, domain vocabulary, or contract ownership.
