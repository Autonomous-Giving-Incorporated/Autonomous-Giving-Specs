...
This repository owns specifications, architecture, ADRs, contracts, schemas, event definitions, terminology, design-system requirements, the canonical demo, documentation standards, versioning, and conformance. It does not own business logic, UI or API implementations, databases, deployment, or infrastructure.
...
6. Every service owns one responsibility.
