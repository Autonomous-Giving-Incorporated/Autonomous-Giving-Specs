...
6. Prefer a modular monolith ([implementation guidance](implementation-guidance.md)); treat deployment topology as irrelevant to conformance ([SPEC-013](../specs/SPEC-013-repository-conformance.md)).
